...
export class User {
  ...
  @ApiProperty({
    description: 'Identity document URL (CCCD/Passport)',
    required: false,
  })
  @Prop()
  ...
  @ApiProperty({
    description: 'Selfie photo URL holding identity document',
    required: false,
  })
  @Prop()
  ...
  @ApiProperty({
    description: 'Additional verification note from user',
    required: false,
  })
  @Prop()
