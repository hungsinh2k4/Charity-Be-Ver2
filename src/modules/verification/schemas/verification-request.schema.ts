...
export class VerificationRequest {
    @ApiProperty({ enum: EntityType, description: 'Type of entity being verified' })
    ...
    @ApiProperty({ enum: RequestStatus, description: 'Current status of the request' })
    ...
    @ApiProperty({ description: 'Admin/Auditor who reviewed the request', required: false })
    ...
    @ApiProperty({ description: 'Date when request was reviewed', required: false })
    @Prop()
    reviewedAt?: Date;
