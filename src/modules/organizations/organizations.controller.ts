...
export class OrganizationsController {
  ...
  @ApiBearerAuth()
  @ApiOperation({
    summary: 'Create a new organization (requires verified user)',
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiOperation({
    summary:
      'Request verification for organization (requires legal documents to be uploaded first)',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiResponse({
    status: 400,
    description:
      'Legal documents are required or verification already pending/completed',
  })
  @ApiResponse({
    status: 403,
    description:
